...
export class ApartmentsforsaleComponent {
  ...
  faqs = [
    {
      question: 'What is the difference between buying a villa and an apartment in Dubai?',
    ...
    },
    {
      ...
      answer: `<ol class="text-muted mb-4">
                        <li>Studio apartment</li>
                        <li>bedroom apartment</li>
                        <li>bedroom apartment</li>
                        <li>bedroom apartment</li>
    ...
    {
      question: 'What is the property cost involved while buying an apartment in Dubai?',
