...
export class BlogslistComponent {
  constructor(private blogsservice : BlogsService,private dropdownservice : DropdownsService, private routerblogs : Router) {}
  ...
  getBlogsCategory(){
    this.dropdownservice.GetBlogCategoryList(this.blogsCategoryobj).subscribe((result:any) => {
