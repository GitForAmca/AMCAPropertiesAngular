...
export class PenthouseforsaleComponent {
  faqs = [
    ...
    },
    {
      ...
      answer: `<p class="text-muted mb-4">Penthouses in Dubai offer comfort and luxurious lifestyles. With their unique features and high demand, they are the best choice for profitable investment. They allow investors to enjoy a dream lifestyle while generating significant ROI.</p>
                    `,
      open: false
    },
    {
      question: 'What are the most popular areas for buying luxury penthouses in Dubai?',
