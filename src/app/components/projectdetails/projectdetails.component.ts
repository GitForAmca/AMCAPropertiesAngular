...
export class ProjectdetailsComponent {
  ...
  ngOnInit() {
    debugger;
    this.projectPageURL = this.route.snapshot.paramMap.get('pageURL')!;
    this.unitDetailsobj.projectPageURL = this.projectPageURL;
    this.unitdetailsservice
      .GetProjectDetailsService(this.unitDetailsobj)
      .subscribe((res: any) => {
        debugger;
        ...
        this.projectId = firstItem?.projectId ?? 0;
        this.GetUnitDetails();
      });
  }
  ...
  GetUnitDetails() {
    ...
    this.unitdetailsservice
      ...
      .subscribe((result: any) => {
        ...
        this.unitdetailsservice
          .GetProjectDetailsListService(this.unitDetailsListobj)
          .subscribe((result: any) => {
        ...
        //Get Amenities List
        this.unitdetailsservice
          .GetProjectAmenitiesService(this.unitAmenitiesListobj)
          .subscribe((result: any) => {
        ...
        //Get Places Near By
        this.unitdetailsservice
          .GetProjectPlacesNearBy(this.projectPlacesNearByobj)
          .subscribe((result: any) => {
        ...
        //Get Video
        this.unitdetailsservice
          .GetProjectImagesService(this.unitVideosobj)
          .subscribe((result: any) => {
        ...
        //Get Images
        this.unitdetailsservice
          .GetProjectImagesService(this.unitImagesobj)
          .subscribe((result: any) => {
