...
export class PropertydetailsComponent {
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,private route: ActivatedRoute,private unitdetailsservice : UnitdetailsService,private sanitizer: DomSanitizer) {}
    ...
    GetUnitDetails(){
      ...
      this.unitdetailsservice.GetUnitDetailsService(this.unitDetailsobj).subscribe((result : any) => {
        ...
        this.unitdetailsservice.GetUnitDetailsListService(this.unitDetailsListobj).subscribe((result : any) => {
          this.unitDetailsList = result;

        });

        //Get Amenities List
        this.unitdetailsservice.GetUnitAmenitiesService(this.unitAmenitiesListobj).subscribe((result : any) => {
          this.unitAmenitiesList = result;
        });

        //Get Places Near By
        this.unitdetailsservice.GetUnitPlacesNearBy(this.unitPlacesNearByobj).subscribe((result : any) => {
          this.unitPlacesNearBy = result;
        });

        //Get Video
        this.unitdetailsservice.GetUnitImagesService(this.unitVideosobj).subscribe((result : any) => {
